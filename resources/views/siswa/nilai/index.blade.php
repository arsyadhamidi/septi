...
@section('content')
    <div class="row">
        <div class="col-lg">
            @php
                $nilaiss = \App\Models\NilaiSiswa::where('users_id', Auth()->user()->id)->first();
            @endphp
            @if ($nilaiss)
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg">
                                        <img src="{{ asset('images/vektor.png') }}" alt="vektor" class="img-fluid">
                                    </div>
                                    <div class="col-lg m-auto">
                                        <h3>Hi, {{ Auth()->user()->name ?? '-' }}</h3>
                                        <p>Ini adalah hasil tes dari pekerjaan Anda, dan tes ini bersifat mutlak. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endphp
                    @if ($nilais)
                        <a href="{{ route('siswa-nilai.generatepdf') }}" class="btn btn-danger mb-3" target="_blank">
                            Download Hasil Test
                        </a>
                    @endif
...
@php
    $nilaiSoals = 0;
    $nilaiSubSoals = 0;
    $nilaiSiswas = \App\Models\NilaiSiswa::where('users_id', Auth()->user()->id)->get();
