                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="kodejurusan"
                                        ...
                                        value="{{ old('kodejurusan', $jurusans->kodejurusan ?? '') }}">
                                    @error('kodejurusan')
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="namajurusan"
                                        ...
                                        value="{{ old('namajurusan', $jurusans->namajurusan ?? '') }}">
                                    @error('namajurusan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsijurusan" class="form-control @error('deskripsijurusan') is-invalid @enderror" id="editor">{{ old('deskripsijurusan', $jurusans->deskripsijurusan ?? '') }}</textarea>
