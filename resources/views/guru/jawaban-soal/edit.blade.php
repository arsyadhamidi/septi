...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('guru-soal.updatejawaban', $jawabans->id) }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('guru-soal.show', $jawabans->soal_id) }}" class="btn btn-info">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jawabansoal"
                                ...
                                value="{{ old('jawabansoal', $jawabans->jawabansoal) }}" placeholder="Masukan jawaban">
                            @error('jawabansoal')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nilaijawabansoal"
                                ...
                                value="{{ old('nilaijawabansoal', $jawabans->nilaijawabansoal) }}"
                                placeholder="Masukan nilai jawaban">
